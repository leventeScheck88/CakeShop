...
const contact_message_entity_1 = require("./modules/contact/entities/contact-message.entity");
(0, dotenv_1.config)();
const dataSource = new typeorm_1.DataSource({
    ...
    entities: [category_entity_1.Category, product_entity_1.Product, order_entity_1.Order, contact_message_entity_1.ContactMessage],
    synchronize: true,
});
const categories = [
    {
        name: 'Torturi',
        slug: 'torturi',
        description: 'Torturi personalizate pentru zile de naștere, aniversări și evenimente speciale',
        sortOrder: 1,
    },
    {
        name: 'Torturi de Nuntă',
        slug: 'torturi-de-nunta',
        description: 'Torturi spectaculoase cu mai multe etaje pentru nunta perfectă',
        sortOrder: 2,
    },
    {
...
const products = [
    {
        ...
        description: 'Un tort clasic Red Velvet cu blat pufos și cremă de brânză. Decorat elegant cu petale de trandafir comestibile. Perfect pentru aniversări și ocazii speciale.',
    ...
    },
    {
        ...
        description: 'Tort cu trei straturi de blat de ciocolată însiropat, cremă ganache din ciocolată belgiană și decorațiuni din ciocolată temperată.',
    ...
    },
    {
        ...
        description: 'Tort proaspăt cu blat vanilat, cremă de mascarpone și un mix generos de fructe de pădure: zmeură, afine, mure și căpșuni.',
    ...
    },
    {
        ...
        description: 'Tort de nuntă cu 3-5 etaje, decorat cu flori naturale și detalii din fondant. Disponibil cu diverse umpluturi la alegere.',
    ...
    },
    {
        ...
        description: 'Tort naked cake cu aspect rustic, decorat cu fructe proaspete, flori de câmp și un strop de zahăr pudră. Ideal pentru nunți în aer liber.',
    ...
    },
    {
        name: 'Tort Unicorn',
        slug: 'tort-unicorn',
        description: 'Tort magic cu tematică unicorn, decorat în culori pastelate cu corn auriu, urechi și flori din fondant. Copiii îl adoră!',
    ...
    },
    {
        ...
        description: 'Tort personalizat cu super eroi preferați. Figurine modelate manual din pastă de zahăr. Se poate personaliza cu orice personaj.',
    ...
    },
    {
        ...
        description: 'Specialitatea casei — blat de vanilie, cremă de caramel sărat și glazură oglindă. Un echilibru perfect între dulce și sărat.',
    ...
    },
    {
        ...
        description: 'Combinație rafinată de mousse de fistic și jeleu de zmeură, pe un blat crocant de migdale. Decorat cu fistic măcinat și zmeură proaspătă.',
    ...
    },
    {
        ...
        description: 'Cutie cadou cu 12 fursecuri decorate manual cu glazură regală. Disponibile în diverse tematici: florale, sezoniere, personalizate.',
    ...
    },
    {
        ...
        description: 'Platou generos cu fursecuri asortate: vanilie, ciocolată, fistic, lămâie. Perfect pentru petreceri și evenimente.',
    ...
    },
    {
        ...
        description: 'Cutie elegantă cu 12 macarons în arome la alegere: vanilie, ciocolată, fistic, zmeură, lavandă, caramel, lămâie, trandafir.',
    ...
    },
    {
        ...
        description: 'Cutie cadou premium cu 24 de macarons asortate. Ideală ca dar sau pentru evenimente. Arome sezoniere disponibile.',
    ...
    },
    {
        ...
        description: 'Set de 6 mini tarte cu crustă fragedă, cremă de vanilie și fructe proaspete de sezon. Perfecte ca desert individual.',
    ...
    },
    {
        ...
        description: 'Set de 6 mini tarte cu ganache de ciocolată neagră, decorate cu fulgi de aur comestibil. Un desert rafinat.',
    ...
    },
    {
        ...
        description: 'Pachet complet de candy bar pentru 50 de persoane: mini torturi, macarons, fursecuri, mini tarte și cake pops. Aranjament inclus.',
    ...
    },
    {
        ...
        description: 'Pachet premium de candy bar pentru 100+ persoane: selecție extinsă de deserturi, decorațiuni personalizate și livrare inclusă.',
...
async function seed() {
    ...
    for (const prod of products) {
        ...
        await productRepo.save(productRepo.create({ ...productData, categoryId: category.id }));
        productCount++;
    }
